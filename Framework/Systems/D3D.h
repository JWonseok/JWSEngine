...
public:
	...
	static ID3D11DeviceContext* GetDC() { return context; }
	...
	void Clear(Color color = Color(0xFF555566), ID3D11RenderTargetView* rtv = NULL, ID3D11DepthStencilView* dsv = NULL);
	void Present();
